### Когда нужно индексировать внешний ключ:
  ...
  4. НЕ ПОДТВЕРДИЛОСЬ на практике. Обновление первичного ключа либо удаление записи из родительской таблицы поместит блокировку на всю дочернюю таблицу. Из-за этого снижается степерь параллелизма.
