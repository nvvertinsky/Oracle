...
0. Обновление первичного ключа либо удаление записи из родительской таблицы поместит блокировку на всю дочернюю таблицу. Из-за этого снижается степерь параллелизма. НЕ ПОДТВЕРДИЛОСЬ на практике.
