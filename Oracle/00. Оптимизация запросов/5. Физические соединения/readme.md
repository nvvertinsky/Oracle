...
Когда применяется: 
  - Когда нужны все строки сразу, а не первые.

Особенности:
  - Хеш функция может возвращать одно и тоже значение для разных входных параметров. Это хеш колизия. В этом случае Oracle помещает эти ключи в один и тот же слот 
