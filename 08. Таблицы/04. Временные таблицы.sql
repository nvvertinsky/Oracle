...
Описание:
  ...
  3. Если запрос к временной таблицы происходит из процедуры с правами владельца, значит временные данные будут храниться во временном табличном пространстве владельца.
